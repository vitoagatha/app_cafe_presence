        ...
        <div class="navbar-nav flex-row order-md-last">
          <div class="nav-item dropdown">
            ...
            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
              <a href="<?= base_url('manajer/profile/profile.php') ?>" class="dropdown-item">Profile</a>
              <a href="<?= base_url('manajer/profile/ubah_password.php') ?>" class="dropdown-item">Ubah Password</a>
      ...
      <div class="collapse navbar-collapse" id="navbar-menu">
        <div class="navbar">
          <div class="container-xl">
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('manajer/home/home.php') ?>">
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('manajer/presensi_manajer/presensi.php') ?>">
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('manajer/data_pegawai/pegawai.php') ?>">
                  <span class="nav-link-icon d-md-none d-lg-inline-block"><!-- Download SVG icon from http://tabler-icons.io/i/home -->
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="<?= base_url('manajer/data_jabatan/jabatan.php') ?>">
                        Jabatan
                      </a>
                      <a class="dropdown-item" href="<?= base_url('manajer/data_lokasi_presensi/lokasi_presensi.php') ?>">
                        Lokasi Presensi
                      </a>
                    </div>
                  </div>
              ...
              <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                  <div class="dropdown-menu-columns">
                    <div class="dropdown-menu-column">
                      <a class="dropdown-item" href="<?= base_url('manajer/rekap_presensi/rekap_harian.php') ?>">
                        Rekap Harian
                      </a>
                      <a class="dropdown-item" href="<?= base_url('manajer/rekap_presensi/rekap_bulanan.php') ?>">
                        Rekap Bulanan
                      </a>
                    </div>
                  </div>
              ...
              <li class="nav-item">
                <a class="nav-link" href="<?= base_url('manajer/data_ketidakhadiran/ketidakhadiran.php') ?>">
