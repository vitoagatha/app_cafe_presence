...
?>
 ...
 <div class="page-body">
    ...
    <a href="<?= base_url('manajer/data_pegawai/tambah.php') ?>" class="btn btn-primary"><span class="text"><i class="fa-solid fa-plus"></i> Tambah Data</span></a>
    ...
    <table class="table table-bordered mt-3">
        ...
        <?php } else { ?>
            ...
            <tr class="text-center">
                ...
                <td><?= $pegawai['role']?></td>
                <td>
                    <a href="<?= base_url('manajer/data_pegawai/detail.php?id=' . $pegawai
                    ['id'])?>" class="badge bg-primary">Detail</a>

                    <a href="<?= base_url('manajer/data_pegawai/edit.php?id=' . $pegawai
                    ['id'])?>" class="badge bg-primary">Edit</a>

                    <a href="<?= base_url('manajer/data_pegawai/hapus.php?id=' . $pegawai
