...
if (empty($_GET['tanggal_dari'])) {
    ...
    FROM presensi JOIN pegawai ON presensi.id_pegawai = pegawai.id WHERE tanggal_masuk = '$tanggal_hari_ini' 
...
<div class="modal" id="exampleModal" tabindex="-1">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form method="POST" action="<?= base_url('manajer/rekap_presensi/rekap_harian_excel.php') ?>">
