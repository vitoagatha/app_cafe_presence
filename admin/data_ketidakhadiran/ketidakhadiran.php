                ...
                <tr>
                    ...
                    <td class="text-center">
                        <?php if($data['status_pengajuan'] == 'PENDING') : ?>
                            <a class="badge bg-warning" href="<?= base_url('admin/data_ketidakhadiran/detail.php?id=' . $data['id']) ?>">PENDING</a>
                            <?php elseif($data['status_pengajuan'] == 'REJECTED') : ?> 
                                <a class="badge bg-danger" href="<?= base_url('admin/data_ketidakhadiran/detail.php?id=' . $data['id']) ?>">REJECTED</a>
                            <?PHP else : ?>
                                <a class="badge bg-success" href="<?= base_url('admin/data_ketidakhadiran/detail.php?id=' . $data['id']) ?>">APPROVED</a>
                            <?PHP endif; ?>
                    </td>
                </tr>
                <?php endwhile; ?>
